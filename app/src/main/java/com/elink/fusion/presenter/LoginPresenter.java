...
public class LoginPresenter implements Presenter {
    ...
    private BaseBean baseDataListBean = null;
     ...
     *
     */
    public void userLoginPresenter(String user, String password) {
        Observable<BaseBean> getFlowListObservable = dataModel.userLoginObservable(user, password);
        getFlowListObservable
                ...
                .subscribe(new Observer<BaseBean>() {
                    ...
                    @Override
                    public void onNext(BaseBean baseDataListBeans) {
                        L.e("onNext");
